...
// Function to handle the submit of the form and intercept the default event
  submitHandler = function () {
   ...
   // Si Stripe fue inicializado correctamente...
   if(Stripe){
...
// Initiate submit handler listener for any form with clas css_form
...
// Set up plan change event listener #tenant_plan in he forms for class cc_form
...
// Function to show erros when Stripe functionality returns an error
